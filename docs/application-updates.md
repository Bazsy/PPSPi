...
```console
sudo ppstime-update check --version 0.2.2 --public-key /secure/path/ppspi-update.pub
```
...
can apply a published, signed same-series release such as v0.2.2 directly.
...
```console
sudo ppstime-config set APP_UPDATE_VERSION 0.2.2
