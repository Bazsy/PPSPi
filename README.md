...
> [!IMPORTANT]
> PPSPi is early-stage software. Version 0.2.3 retains the v0.2.0 hardware-tested
...
| --- | --- | --- | --- |
| Release-tested | Raspberry Pi 4 Model B Rev 1.5 | Uputronics GPS/RTC Expansion Board Rev 6.4 using the V6.0+ profile | Available in v0.2.3 |
