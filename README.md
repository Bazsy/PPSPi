...
> [!IMPORTANT]
> PPSPi is early-stage software. Version 0.2.6 retains the v0.2.0 hardware-tested
...
> corrected that defect but its application archive was rejected by the deployed
> v0.2.3 updater before mutation; v0.2.6 restores that upgrade compatibility.
> Physical v0.2.6 apply, local rollback/reapply, routed denial, and public-image
> smoke remain tracked in
...
| --- | --- | --- | --- |
| Release-tested | Raspberry Pi 4 Model B Rev 1.5 | Uputronics GPS/RTC Expansion Board Rev 6.4 using the V6.0+ profile | Available in v0.2.6 |
...
- [v0.2.3 hardware report](docs/hardware-test-report-v0.2.3.md)
- [v0.2.3 release readiness](docs/release-readiness-v0.2.3.md)
- [v0.2.3 release notes](docs/release-notes-v0.2.3.md)
...
- [v0.2.6 hardware report](docs/hardware-test-report-v0.2.6.md)
- [v0.2.6 release readiness](docs/release-readiness-v0.2.6.md)
- [v0.2.6 release notes](docs/release-notes-v0.2.6.md)
